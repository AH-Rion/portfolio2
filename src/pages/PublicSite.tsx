  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      fetchProjects().catch((e) => {
        console.error('[PublicSite] fetchProjects failed:', e);
        return [] as Project[];
      }),
      fetchExperience(),
      fetchCertificates(),
      ...
      .catch((err) => {
        console.error('[PublicSite] content load failed:', err);
        if (!active) return;
    ...
    <div className="relative min-h-screen bg-ink-950 text-slate-200">
      ...
      <main className="relative z-10">
        <Loader loading={!loaded}>
          ...
          <Projects projects={projects} loading={!loaded} error={projectsError} />
